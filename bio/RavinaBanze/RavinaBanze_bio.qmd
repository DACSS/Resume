...
<a href = "Ravina_CV.pdf" title = "Ravina_Resume" target="_blank" > <button type="button" class="resume btn rounded-pill bg-light-success btn-lg w-100"> <i class="bi bi-cloud-download"></i> Resume </button> </a>
