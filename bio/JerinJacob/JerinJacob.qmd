...
<a href = "cv.pdf" target= "_blank" title = "JerinJacob_Resume"> <button type="button" class="resume btn rounded-pill bg-light-success btn-lg w-100"> <i class="bi bi-cloud-download"></i> Resume </button> </a>
