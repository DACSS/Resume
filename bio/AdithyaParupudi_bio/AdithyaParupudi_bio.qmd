...
categories: [fall23, part-time, healthcare, operations, finance]
---

<!-- Resume download button -->

<a href = "cv.pdf" title = "Adithya_Resume" target="_blank" > <button type="button" class="resume btn rounded-pill bg-light-success btn-lg w-100"> <i class="bi bi-cloud-download"></i> Resume </button> </a>
